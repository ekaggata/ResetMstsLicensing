...
## Binary downloads
A pre-built exe file is available for download in ResetMstsLicensing/ResetMstsLicensing/bin/Release, you can download and start using it straight away, no need to build it from the source code.
